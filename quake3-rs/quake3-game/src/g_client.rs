...
use bg_public_h::{
    ...
    unnamed_5, unnamed_6, BOTH_DEAD1, BOTH_DEAD2, BOTH_DEAD3, BOTH_DEATH1, BOTH_DEATH2,
    BOTH_DEATH3, EV_BULLET, EV_BULLET_HIT_FLESH, EV_BULLET_HIT_WALL, EV_CHANGE_WEAPON, EV_DEATH1,
...
use q_shared_h::{
    ...
    unnamed, usercmd_s, usercmd_t, va, vec3_t, vec_t, vmCvar_t, Info_Validate, Info_ValueForKey,
    Q_IsColorString, Q_stricmp, Q_strncpyz, EXEC_APPEND, EXEC_INSERT, EXEC_NOW, TR_GRAVITY,
