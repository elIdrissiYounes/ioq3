use bg_public_h::{
    ...
    pmove_t, team_t, unnamed, unnamed_0, unnamed_1, unnamed_2, unnamed_3, unnamed_4,
    BG_AddPredictableEventToPlayerstate, BG_CanItemBeGrabbed, BG_EvaluateTrajectory,
    BG_PlayerTouchesItem, BG_TouchJumpPad, PM_UpdateViewAngles, Pmove, ET_BEAM, ET_EVENTS,
    ...
    EV_WATER_UNDER, GENDER_FEMALE, GENDER_MALE, GENDER_NEUTER, GT_1FCTF, GT_CTF, GT_FFA,
...
use q_shared_h::{
    ...
    trType_t, trace_t, trajectory_t, usercmd_s, usercmd_t, vec3_origin, vec3_t, vec_t, vmCvar_t,
    LerpAngle, TR_GRAVITY, TR_INTERPOLATE, TR_LINEAR, TR_LINEAR_STOP, TR_SINE, TR_STATIONARY,
};
use stdlib::sqrt;
use tr_types_h::{
...
pub unsafe extern "C" fn CG_BuildSolidList() {
    ...
    while i < (*snap).numEntities {
        cent = &mut cg_entities[(*snap).entities[i as usize].number as usize] as *mut centity_t;
