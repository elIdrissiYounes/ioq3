...
pub unsafe extern "C" fn RE_AddPolyToScene(
    ...
    while j < numPolys {
        ...
        if crate::src::renderergl1::tr_main::tr.world.is_null() {
            fogIndex = 0
        } else if (*crate::src::renderergl1::tr_main::tr.world).numfogs == 1 {
            fogIndex = 0
        } else {
...
pub unsafe extern "C" fn RE_AddRefEntityToScene(mut ent: *const crate::tr_types_h::refEntity_t) {
    ...
    if crate::src::qcommon::q_math::Q_isnan((*ent).origin[0]) != 0
        || crate::src::qcommon::q_math::Q_isnan((*ent).origin[1]) != 0
        || crate::src::qcommon::q_math::Q_isnan((*ent).origin[2]) != 0
    {
...
pub unsafe extern "C" fn RE_AddDynamicLightToScene(
    ...
    (*dl).origin[0] = *org.offset(0);
    (*dl).origin[1] = *org.offset(1);
    (*dl).origin[2] = *org.offset(2);
    (*dl).radius = intensity;
    (*dl).color[0] = r;
    (*dl).color[1] = g;
    (*dl).color[2] = b;
...
pub unsafe extern "C" fn RE_RenderScene(mut fd: *const crate::tr_types_h::refdef_t) {
        ...
        && (*fd).rdflags & 0x1 == 0
    {
        crate::src::renderergl1::tr_main::ri
            ...
            .expect("non-null function pointer")(
            crate::src::qcommon::q_shared::ERR_DROP as i32,
            b"R_RenderScene: NULL worldmodel\x00" as *const u8 as *const i8,
        );
    }
    crate::stdlib::memcpy(
    ...
    crate::src::renderergl1::tr_main::tr.refdef.floatTime =
        crate::src::renderergl1::tr_main::tr.refdef.time as f64 * 0.001;
