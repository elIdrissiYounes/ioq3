...
use libc;
use q_shared_h::{
    byte, entityState_s, entityState_t, g_color_table, gameState_t, playerState_s, playerState_t,
    qboolean, qfalse, qhandle_t, qtrue, sfxHandle_t, trType_t, trajectory_t, vec3_t, vec4_t, vec_t,
