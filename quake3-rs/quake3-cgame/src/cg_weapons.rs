...
use bg_public_h::{
    ...
    unnamed_0, unnamed_1, unnamed_2, unnamed_3, unnamed_4, unnamed_5, weapon_t, BOTH_DEAD1,
    ...
    ET_SPEAKER, ET_TEAM, ET_TELEPORT_TRIGGER, FLAG_RUN, FLAG_STAND, FLAG_STAND2RUN, GENDER_FEMALE,
    GENDER_MALE, GENDER_NEUTER, GT_1FCTF, GT_CTF, GT_FFA, GT_HARVESTER, GT_MAX_GAME_TYPE,
    GT_OBELISK, GT_SINGLE_PLAYER, GT_TEAM, GT_TOURNAMENT, IT_AMMO, IT_ARMOR, IT_BAD, IT_HEALTH,
    IT_HOLDABLE, IT_PERSISTANT_POWERUP, IT_POWERUP, IT_TEAM, IT_WEAPON, LEGS_BACK, LEGS_BACKCR,
...
use q_shared_h::{
    ...
    gameState_t, orientation_t, playerState_s, playerState_t, qboolean, qfalse, qhandle_t, qtrue,
    sfxHandle_t, trType_t, trace_t, trajectory_t, unnamed, vec3_t, vec_t, vmCvar_t,
    COM_StripExtension, Q_strcat, CHAN_ANNOUNCER, CHAN_AUTO, CHAN_BODY, CHAN_ITEM, CHAN_LOCAL,
