...
unsafe extern "C" fn h2v1_merged_upsample(
    ...
    while col > 0 {
        ...
        *outptr.offset(1) = *range_limit.offset((y + cgreen) as isize);
        *outptr.offset(2) = *range_limit.offset((y + cblue) as isize);
...
unsafe extern "C" fn h2v2_merged_upsample(
    ...
    while col > 0 {
        ...
        *outptr0.offset(1) = *range_limit.offset((y + cgreen) as isize);
        *outptr0.offset(2) = *range_limit.offset((y + cblue) as isize);
        outptr0 = outptr0.offset(3);
        let fresh7 = inptr00;
        inptr00 = inptr00.offset(1);
        y = *fresh7 as i32;
        *outptr0.offset(0) = *range_limit.offset((y + cred) as isize);
        ...
        *outptr0.offset(2) = *range_limit.offset((y + cblue) as isize);
        ...
        y = *fresh8 as i32;
        *outptr1.offset(0) = *range_limit.offset((y + cred) as isize);
        *outptr1.offset(1) = *range_limit.offset((y + cgreen) as isize);
        *outptr1.offset(2) = *range_limit.offset((y + cblue) as isize);
        outptr1 = outptr1.offset(3);
        let fresh9 = inptr01;
        inptr01 = inptr01.offset(1);
        y = *fresh9 as i32;
        *outptr1.offset(0) = *range_limit.offset((y + cred) as isize);
