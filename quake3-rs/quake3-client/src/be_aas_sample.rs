...
#[header_src =
      "/home/miguelsaldivar/workspace/ioq3/code/botlib/be_aas_sample.c"]
    ...
    loop  {
        ...
        if nodenum < 0i32 {
            ...
            if front >= -0i32 as libc::c_float &&
                ...
                tstack_p = tstack_p.offset(1isize);
                if tstack_p >=
                       &mut tracestack[126usize] as *mut aas_tracestack_t {
                    botimport.Print.expect("non-null function pointer")(3i32,
    ...
    loop  {
        ...
        if nodenum < 0i32 {
            ...
            *fresh2 = link
            ...
            //end if
            if lstack_p >= &mut linkstack[127usize] as *mut aas_linkstack_t {
                botimport.Print.expect("non-null function pointer")(3i32,
                ...
                //end if
                if !(lstack_p >=
                         &mut linkstack[127usize] as *mut aas_linkstack_t) {
                    continue ;
                }
                botimport.Print.expect("non-null function pointer")(3i32,
                                                                    b"AAS_LinkEntity: stack overflow\n\x00"
