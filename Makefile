...
Q3CGOBJ_ = \
  ...
  $(B)/$(BASEGAME)/cgame/cg_variadic.o \
  \
...
MPGOBJ_ = \
  ...
  $(B)/$(MISSIONPACK)/game/ai_variadic.o \
  ...
  $(B)/$(MISSIONPACK)/game/g_variadic.o \
  \
  $(B)/$(MISSIONPACK)/qcommon/q_math.o \
  $(B)/$(MISSIONPACK)/qcommon/q_shared.o
