...
use bg_public_h::{
    animation_s, animation_t, gametype_t, gender_t, team_t, unnamed, ET_BEAM, ET_EVENTS,
    ET_GENERAL, ET_GRAPPLE, ET_INVISIBLE, ET_ITEM, ET_MISSILE, ET_MOVER, ET_PLAYER, ET_PORTAL,
    ET_PUSH_TRIGGER, ET_SPEAKER, ET_TEAM, ET_TELEPORT_TRIGGER, GENDER_FEMALE, GENDER_MALE,
