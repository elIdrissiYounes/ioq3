...
use bg_public_h::{
    ...
    unnamed_3, unnamed_4, unnamed_5, unnamed_6, unnamed_7, weapon_t, BG_FindItemForPowerup,
    BG_FindItemForWeapon, BOTH_DEAD1, BOTH_DEAD2, BOTH_DEAD3, BOTH_DEATH1, BOTH_DEATH2,
    ...
    EV_BULLET, EV_BULLET_HIT_FLESH, EV_BULLET_HIT_WALL, EV_CHANGE_WEAPON, EV_DEATH1, EV_DEATH2,
    EV_DEATH3, EV_DEBUG_LINE, EV_FALL_FAR, EV_FALL_MEDIUM, EV_FALL_SHORT, EV_FIRE_WEAPON,
    EV_FOOTSPLASH, EV_FOOTSTEP, EV_FOOTSTEP_METAL, EV_FOOTWADE, EV_GENERAL_SOUND, EV_GIB_PLAYER,
...
use q_shared_h::{
    ...
    usercmd_s, usercmd_t, vec3_origin, vec3_t, vec_t, vmCvar_t, VectorNormalize, TR_GRAVITY,
