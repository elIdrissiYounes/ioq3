...
use bg_public_h::{
    gitem_s, gitem_t, itemType_t, team_t, unnamed, unnamed_0, weapon_t, BG_FindItemForWeapon,
    ...
    IT_HEALTH, IT_HOLDABLE, IT_PERSISTANT_POWERUP, IT_POWERUP, IT_TEAM, IT_WEAPON, TEAM_BLUE,
...
use q_shared_h::{
    ...
    vec3_t, vec_t, AngleVectors, DirToByte, PerpendicularVector, VectorNormalize, TR_GRAVITY,
