...
use bg_public_h::{
    gitem_s, gitem_t, itemType_t, team_t, unnamed, unnamed_0, unnamed_1,
    BG_AddPredictableEventToPlayerstate, ET_BEAM, ET_EVENTS, ET_GENERAL, ET_GRAPPLE, ET_INVISIBLE,
...
use q_shared_h::{
    ...
    va, vec3_t, vec_t, AngleVectors, Com_sprintf, Q_strcat, Q_stricmp, VectorNormalize, TR_GRAVITY,
