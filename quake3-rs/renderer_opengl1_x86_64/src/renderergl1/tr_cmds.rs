...
pub unsafe extern "C" fn R_PerformanceCounters() {
    if (*crate::src::renderergl1::tr_init::r_speeds).integer == 0 {
        ...
        crate::stdlib::memset(
            ...
            0,
            ::std::mem::size_of::<crate::tr_local_h::frontEndCounters_t>(),
        );
        crate::stdlib::memset(
            &mut crate::src::renderergl1::tr_backend::backEnd.pc
                as *mut crate::tr_local_h::backEndCounters_t as *mut libc::c_void,
            0,
            ::std::mem::size_of::<crate::tr_local_h::backEndCounters_t>(),
        );
        return;
    }
    if (*crate::src::renderergl1::tr_init::r_speeds).integer == 1 {
        crate::src::renderergl1::tr_main::ri
            ...
            crate::src::renderergl1::tr_backend::backEnd.pc.c_indexes / 3i32,
    ...
    } else if (*crate::src::renderergl1::tr_init::r_speeds).integer == 2 {
        crate::src::renderergl1::tr_main::ri
            .Printf
            .expect("non-null function pointer")(
            crate::src::qcommon::q_shared::PRINT_ALL as i32,
    ...
    } else if (*crate::src::renderergl1::tr_init::r_speeds).integer == 3 {
        crate::src::renderergl1::tr_main::ri
            .Printf
            .expect("non-null function pointer")(
            crate::src::qcommon::q_shared::PRINT_ALL as i32,
    ...
    } else if (*crate::src::renderergl1::tr_init::r_speeds).integer == 4 {
    ...
    } else if (*crate::src::renderergl1::tr_init::r_speeds).integer == 5 {
        crate::src::renderergl1::tr_main::ri
            .Printf
            .expect("non-null function pointer")(
            crate::src::qcommon::q_shared::PRINT_ALL as i32,
    ...
    } else if (*crate::src::renderergl1::tr_init::r_speeds).integer == 6 {
        crate::src::renderergl1::tr_main::ri
            .Printf
            .expect("non-null function pointer")(
            crate::src::qcommon::q_shared::PRINT_ALL as i32,
...
pub unsafe extern "C" fn R_GetCommandBufferReserved(
    ...
    bytes = ((bytes as usize)
        ...
        .wrapping_sub(1usize)
        & !(::std::mem::size_of::<*mut libc::c_void>()).wrapping_sub(1usize)) as i32;
    ...
    if (((*cmdList).used + bytes) as usize)
        ...
        > 0x40000i32 as usize
    {
        if bytes as usize > (0x40000i32 as usize).wrapping_sub(::std::mem::size_of::<i32>()) {
            crate::src::renderergl1::tr_main::ri
                .Error
                .expect("non-null function pointer")(
                crate::src::qcommon::q_shared::ERR_FATAL as i32,
                b"R_GetCommandBuffer: bad size %i\x00" as *const u8 as *const i8,
                bytes,
            );
        }
...
pub unsafe extern "C" fn R_GetCommandBuffer(mut bytes: i32) -> *mut libc::c_void {
    return R_GetCommandBufferReserved(
        bytes,
        ((::std::mem::size_of::<crate::tr_local_h::swapBuffersCommand_t>())
            .wrapping_add(::std::mem::size_of::<*mut libc::c_void>())
            .wrapping_sub(1usize)
            & !(::std::mem::size_of::<*mut libc::c_void>()).wrapping_sub(1usize)) as i32,
    );
...
pub unsafe extern "C" fn R_AddDrawSurfCmd(
    ...
    cmd = R_GetCommandBuffer(::std::mem::size_of::<crate::tr_local_h::drawSurfsCommand_t>() as i32)
...
pub unsafe extern "C" fn RE_SetColor(mut rgba: *const f32) {
    ...
    cmd = R_GetCommandBuffer(::std::mem::size_of::<crate::tr_local_h::setColorCommand_t>() as i32)
    ...
    if rgba.is_null() {
        static mut colorWhite: [f32; 4] = [1f32, 1f32, 1f32, 1f32];
        rgba = colorWhite.as_mut_ptr()
    }
    (*cmd).color[0] = *rgba.offset(0);
    (*cmd).color[1] = *rgba.offset(1);
    (*cmd).color[2] = *rgba.offset(2);
    (*cmd).color[3] = *rgba.offset(3);
}
/*
=============
RE_StretchPic
...
pub unsafe extern "C" fn RE_StretchPic(
    ...
    cmd = R_GetCommandBuffer(::std::mem::size_of::<crate::tr_local_h::stretchPicCommand_t>() as i32)
...
pub unsafe extern "C" fn R_SetColorMode(
    ...
    let ref mut fresh0 = *rgba.offset(3);
    *fresh0 = 1u8;
    let ref mut fresh1 = *rgba.offset(2);
    *fresh1 = *fresh0;
    let ref mut fresh2 = *rgba.offset(1);
    *fresh2 = *fresh1;
    *rgba.offset(0) = *fresh2;
    if colormode > 4 {
        if stereoFrame == crate::tr_types_h::STEREO_LEFT {
            stereoFrame = crate::tr_types_h::STEREO_RIGHT
        } else if stereoFrame == crate::tr_types_h::STEREO_RIGHT {
    ...
    if colormode == 4 {
        if stereoFrame == crate::tr_types_h::STEREO_LEFT {
            let ref mut fresh3 = *rgba.offset(2);
            *fresh3 = 0u8;
            *rgba.offset(0) = *fresh3
        } else if stereoFrame == crate::tr_types_h::STEREO_RIGHT {
            *rgba.offset(1) = 0u8
        }
    } else if stereoFrame == crate::tr_types_h::STEREO_LEFT {
        let ref mut fresh4 = *rgba.offset(2);
        *fresh4 = 0u8;
        *rgba.offset(1) = *fresh4
    } else if stereoFrame == crate::tr_types_h::STEREO_RIGHT {
        *rgba.offset(0) = 0u8;
        if colormode == 2 {
            *rgba.offset(1) = 0u8
...
pub unsafe extern "C" fn RE_BeginFrame(mut stereoFrame: crate::tr_types_h::stereoFrame_t) {
    ...
    crate::src::renderergl1::tr_main::tr.frameSceneNum = 0;
    //
    ...
    if (*crate::src::renderergl1::tr_init::r_measureOverdraw).integer != 0 {
        if crate::src::renderergl1::tr_init::glConfig.stencilBits < 4 {
        ...
        } else if (*crate::src::renderergl1::tr_init::r_shadows).integer == 2 {
            crate::src::renderergl1::tr_main::ri
                .Printf
                .expect("non-null function pointer")(
                crate::src::qcommon::q_shared::PRINT_ALL as i32,
            ...
            crate::src::sdl::sdl_glimp::qglStencilMask.expect("non-null function pointer")(!(0u32));
            crate::src::sdl::sdl_glimp::qglClearStencil.expect("non-null function pointer")(0);
    ...
    if (*crate::src::renderergl1::tr_init::r_ignoreGLErrors).integer == 0 {
        ...
        if err != 0 {
            crate::src::renderergl1::tr_main::ri
                ...
                .expect("non-null function pointer")(
                crate::src::qcommon::q_shared::ERR_FATAL as i32,
                b"RE_BeginFrame() - glGetError() failed (0x%x)!\x00" as *const u8 as *const i8,
                err,
            );
        }
    }
    if crate::src::renderergl1::tr_init::glConfig.stereoEnabled as u64 != 0 {
        cmd = R_GetCommandBuffer(
            ::std::mem::size_of::<crate::tr_local_h::drawBufferCommand_t>() as i32,
        ...
        if (*crate::src::renderergl1::tr_init::r_anaglyphMode).integer != 0 {
            ...
            if stereoFrame == crate::tr_types_h::STEREO_LEFT {
                ...
                >() as i32) as *mut crate::tr_local_h::colorMaskCommand_t;
                if colcmd.is_null() {
                    return;
                }
            } else if stereoFrame == crate::tr_types_h::STEREO_RIGHT {
                ...
                >() as i32) as *mut crate::tr_local_h::clearDepthCommand_t;
                if cldcmd.is_null() {
                    return;
                }
...
pub unsafe extern "C" fn RE_EndFrame(mut frontEndMsec: *mut i32, mut backEndMsec: *mut i32) {
    ...
    cmd = R_GetCommandBufferReserved(
        ::std::mem::size_of::<crate::tr_local_h::swapBuffersCommand_t>() as i32,
        0,
    ...
    crate::src::renderergl1::tr_main::tr.frontEndMsec = 0;
    if !backEndMsec.is_null() {
        *backEndMsec = crate::src::renderergl1::tr_backend::backEnd.pc.msec
    }
    crate::src::renderergl1::tr_backend::backEnd.pc.msec = 0;
}
/*
===========================================================================
Copyright (C) 1999-2005 Id Software, Inc.
...
pub unsafe extern "C" fn RE_TakeVideoFrame(
    ...
    cmd = R_GetCommandBuffer(::std::mem::size_of::<crate::tr_local_h::videoFrameCommand_t>() as i32)
