...
use q_shared_h::{
    qboolean, qfalse, qhandle_t, qtrue, sfxHandle_t, unnamed, va, vec4_t, vec_t, Q_isprint,
    Q_isupper, EXEC_APPEND, EXEC_INSERT, EXEC_NOW,
};
    ...
    match key {
        178 => {
            if 0 == (*rb).generic.flags & 0x200i32 as libc::c_uint {
                ...
                current_block_3 = 6496556445524683873;
            }
        }
