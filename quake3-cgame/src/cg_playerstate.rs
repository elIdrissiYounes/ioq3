...
use q_shared_h::{
    ...
    qboolean, qfalse, qhandle_t, qtrue, sfxHandle_t, trType_t, trajectory_t, unnamed, vec3_origin,
    vec3_t, vec_t, vmCvar_t, AngleVectors, CHAN_ANNOUNCER, CHAN_AUTO, CHAN_BODY, CHAN_ITEM,
