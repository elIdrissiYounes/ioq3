    ...
    while ctr > 0 {
                ...
                == 0
        {
            ...
            *wsptr.offset((8i32 * 7) as isize) = dcval;
            ...
            tmp2 = tmp11 - tmp12;
            /* Odd part */
            tmp4 = *inptr.offset((8i32 * 1) as isize)
                as crate::jdct_h::IFAST_MULT_TYPE
                * *quantptr.offset((8i32 * 1) as isize); /* phase 6 */
            tmp5 = *inptr.offset((8i32 * 3) as isize)
                as crate::jdct_h::IFAST_MULT_TYPE
                * *quantptr.offset((8i32 * 3) as isize); /* phase 5 */
            tmp6 = *inptr.offset((8i32 * 5) as isize)
                as crate::jdct_h::IFAST_MULT_TYPE
                * *quantptr.offset((8i32 * 5) as isize); /* 2*c4 */
            tmp7 = *inptr.offset((8i32 * 7) as isize)
                as crate::jdct_h::IFAST_MULT_TYPE
            ...
            tmp7 = z11 + z13;
            tmp11 = ((z11 - z13) as isize * 362
                >> 8) as crate::jdct_h::DCTELEM;
            z5 = ((z10 + z12) as isize * 473
                >> 8) as crate::jdct_h::DCTELEM;
            tmp10 = (z12 as isize * 277
                >> 8) as crate::jdct_h::DCTELEM
                - z5;
            tmp12 = (z10 as isize * -(669)
                >> 8) as crate::jdct_h::DCTELEM
                + z5;
            tmp6 = tmp12 - tmp7;
            tmp5 = tmp11 - tmp6;
    ...
    while ctr < 8 {
            ...
            && *wsptr.offset(7) == 0
        {
            ...
            *outptr.offset(7) = dcval_0;
            ...
            /* Even part */
            tmp10 =
                *wsptr.offset(0) + *wsptr.offset(4);
            tmp11 =
                *wsptr.offset(0) - *wsptr.offset(4);
            tmp13 =
                *wsptr.offset(2) + *wsptr.offset(6);
            tmp12 = ((*wsptr.offset(2)
                - *wsptr.offset(6)) as isize
                * 362
                >> 8) as crate::jdct_h::DCTELEM
                - tmp13;
            tmp0 = tmp10 + tmp13;
            ...
            /* Odd part */
            z13 =
                *wsptr.offset(5) + *wsptr.offset(3); /* phase 5 */
            z10 =
                *wsptr.offset(5) - *wsptr.offset(3); /* 2*c4 */
            z11 =
                *wsptr.offset(1) + *wsptr.offset(7); /* 2*c2 */
            z12 =
                *wsptr.offset(1) - *wsptr.offset(7); /* 2*(c2-c6) */
            tmp7 = z11 + z13; /* -2*(c2+c6) */
            tmp11 = ((z11 - z13) as isize * 362
                >> 8) as crate::jdct_h::DCTELEM; /* phase 2 */
            z5 = ((z10 + z12) as isize * 473
                >> 8) as crate::jdct_h::DCTELEM;
            tmp10 = (z12 as isize * 277
                >> 8) as crate::jdct_h::DCTELEM
