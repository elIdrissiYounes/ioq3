...
use self::ctype_h::{unnamed, _ISalnum, _ISpunct, _IScntrl, _ISblank, _ISgraph,
                    ...
                    _ISlower, _ISupper, __ctype_b_loc, tolower, toupper};
 ...
 -> libc::c_int {
    ...
    if *str.offset(0isize) as libc::c_int == '0' as i32 &&
        ...
        while i < len {
            ...
            n *= 16i32;
            digit =
                tolower(*str.offset(i as isize) as libc::c_int) as
                    libc::c_char;
...
pub unsafe extern "C" fn Q_strlwr(mut s1: *mut libc::c_char)
 -> *mut libc::c_char {
    ...
    s = s1;
    while 0 != *s {
        *s = tolower(*s as libc::c_int) as libc::c_char;
        s = s.offset(1isize)
    }
    return s1;
}
