...
use bg_public_h::{
    ...
    BG_EvaluateTrajectory, BG_EvaluateTrajectoryDelta, ET_BEAM, ET_EVENTS, ET_GENERAL, ET_GRAPPLE,
...
use q_shared_h::{
    ...
    vec3_t, vec_t, DirToByte, VectorNormalize, TR_GRAVITY, TR_INTERPOLATE, TR_LINEAR,
