...
mod bg_local_h {
    ...
    use q_math::{
        axisDefault, colorWhite, g_color_table, vec3_origin, vectoangles, AngleMod,
        AngleNormalize180, AngleSubtract, AngleVectors, AnglesSubtract, AnglesToAxis, AxisClear,
        AxisCopy, ByteToDir, LerpAngle, MatrixMultiply, PerpendicularVector, Q_crandom, Q_random,
        RotateAroundDirection, RotatePointAroundVector, VectorNormalize, VectorNormalize2,
    };
...
mod cg_local_h {
    ...
    pub const LEF_SOUND1: unnamed_0 = 4;
    pub type unnamed = libc::c_uint;
    ...
    pub const LEF_TUMBLE: unnamed = 2;
    ...
    pub const LEF_SOUND2: unnamed = 8;
    pub const LE_FADE_RGB: leType_t = 6;
    pub const LEF_PUFF_DONT_SCALE: unnamed_0 = 1;
...
mod bg_public_h {
    ...
    pub type unnamed_8 = libc::c_uint;
    pub const TORSO_DROP: unnamed_7 = 9;
    ...
    pub const EV_POWERUP_QUAD: unnamed_6 = 61;
    ...
    pub const EV_OBITUARY: unnamed = 60;
    ...
    pub const EV_TAUNT: unnamed_6 = 76;
    ...
    pub const LEGS_IDLE: unnamed_4 = 22;
    pub const TORSO_GETFLAG: unnamed_1 = 25;
    pub const EV_STEP_4: unnamed_6 = 6;
    pub const HI_NUM_HOLDABLE: unnamed_4 = 6;
    pub const EV_TAUNT_YES: unnamed_6 = 77;
    pub type unnamed_7 = libc::c_uint;
    pub const EV_DEATH2: unnamed = 58;
    pub const WP_NONE: unnamed_5 = 0;
    ...
    pub const ET_BEAM: unnamed_7 = 5;
    pub const EV_PROXIMITY_MINE_TRIGGER: unnamed_6 = 67;
    pub const STAT_DEAD_YAW: unnamed_0 = 4;
    ...
    pub const TORSO_GESTURE: unnamed_7 = 6;
    pub const EV_SHOTGUN: unnamed_3 = 54;
    pub const PERS_KILLED: unnamed_2 = 8;
    pub const EV_USE_ITEM4: unnamed = 28;
    pub const IT_BAD: itemType_t = 0;
    pub const PW_HASTE: unnamed_1 = 3;
    ...
    pub const ET_TELEPORT_TRIGGER: unnamed_1 = 9;
    ...
    pub const EV_PLAYER_TELEPORT_IN: unnamed_6 = 42;
    ...
    pub const EV_USE_ITEM14: unnamed = 38;
    pub const EV_MISSILE_MISS: unnamed_3 = 51;
    pub const EV_FOOTSTEP: unnamed_6 = 1;
    pub const PERS_ASSIST_COUNT: unnamed_2 = 12;
    pub const EV_USE_ITEM11: unnamed = 35;
    pub const WP_GRAPPLING_HOOK: unnamed_4 = 10;
    pub const PM_SPINTERMISSION: unnamed_0 = 6;
    pub const IT_HOLDABLE: itemType_t = 6;
    pub const PERS_ATTACKEE_ARMOR: unnamed_1 = 7;
    pub const LEGS_LAND: unnamed_1 = 19;
    ...
    pub const EV_PLAYER_TELEPORT_OUT: unnamed_6 = 43;
    pub const TORSO_PATROL: unnamed_7 = 27;
    ...
    pub const EV_BULLET: unnamed_6 = 55;
    pub const EV_USE_ITEM15: unnamed_3 = 39;
    pub const PW_REGEN: unnamed_3 = 5;
    pub const EV_NOAMMO: unnamed_3 = 21;
    pub const PW_AMMOREGEN: unnamed_0 = 13;
    pub const PERS_SCORE: unnamed_2 = 0;
    pub const EV_INVUL_IMPACT: unnamed_6 = 71;
    ...
    pub const ET_GENERAL: unnamed_7 = 0;
    ...
    pub const BOTH_DEATH1: unnamed_1 = 0;
    pub const GTS_REDTEAM_SCORED: unnamed_4 = 8;
    pub const WP_LIGHTNING: unnamed_5 = 6;
    pub const EV_STEP_16: unnamed_6 = 9;
    pub const PM_DEAD: unnamed = 3;
    ...
    pub const TEAM_SPECTATOR: unnamed_5 = 3;
    pub const EV_STEP_12: unnamed_6 = 8;
    pub type unnamed_0 = libc::c_uint;
    pub type unnamed = libc::c_uint;
    pub const PW_INVULNERABILITY: unnamed_1 = 14;
    pub type gametype_t = libc::c_uint;
    pub const PM_NORMAL: unnamed = 0;
    pub const PERS_ATTACKER: unnamed = 6;
    pub const EV_USE_ITEM0: unnamed = 24;
    pub const PM_NOCLIP: unnamed_0 = 1;
    pub const PERS_DEFEND_COUNT: unnamed_3 = 11;
    pub const EV_FOOTSPLASH: unnamed_6 = 3;
    pub const BOTH_DEATH3: unnamed_7 = 4;
    pub const PW_BLUEFLAG: unnamed_3 = 8;
    pub const WP_NUM_WEAPONS: unnamed_5 = 11;
