...
use self::q_shared_h::{byte, qboolean, qtrue, qfalse, floatint_t, vec_t,
                       vec3_t, vec4_t, cplane_s, cplane_t};
use self::assert_h::{__assert_fail};
use self::mathcalls_h::{acos, atan2, cos, sin, sqrt, fabs};
...
pub static mut colorBlack: vec4_t =
    [0i32 as vec_t, 0i32 as vec_t, 0i32 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorRed: vec4_t =
    [1i32 as vec_t, 0i32 as vec_t, 0i32 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorGreen: vec4_t =
    [0i32 as vec_t, 1i32 as vec_t, 0i32 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorBlue: vec4_t =
    [0i32 as vec_t, 0i32 as vec_t, 1i32 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorYellow: vec4_t =
    [1i32 as vec_t, 1i32 as vec_t, 0i32 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorMagenta: vec4_t =
    [1i32 as vec_t, 0i32 as vec_t, 1i32 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorCyan: vec4_t =
    [0i32 as vec_t, 1i32 as vec_t, 1i32 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorWhite: vec4_t =
    [1i32 as vec_t, 1i32 as vec_t, 1i32 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorLtGrey: vec4_t =
    [0.75f64 as vec_t, 0.75f64 as vec_t, 0.75f64 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorMdGrey: vec4_t =
    [0.5f64 as vec_t, 0.5f64 as vec_t, 0.5f64 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut colorDkGrey: vec4_t =
    [0.25f64 as vec_t, 0.25f64 as vec_t, 0.25f64 as vec_t, 1i32 as vec_t];
#[no_mangle]
pub static mut g_color_table: [vec4_t; 8] =
    [[0.0f64 as vec_t, 0.0f64 as vec_t, 0.0f64 as vec_t, 1.0f64 as vec_t],
     [1.0f64 as vec_t, 0.0f64 as vec_t, 0.0f64 as vec_t, 1.0f64 as vec_t],
     [0.0f64 as vec_t, 1.0f64 as vec_t, 0.0f64 as vec_t, 1.0f64 as vec_t],
     [1.0f64 as vec_t, 1.0f64 as vec_t, 0.0f64 as vec_t, 1.0f64 as vec_t],
     [0.0f64 as vec_t, 0.0f64 as vec_t, 1.0f64 as vec_t, 1.0f64 as vec_t],
     [0.0f64 as vec_t, 1.0f64 as vec_t, 1.0f64 as vec_t, 1.0f64 as vec_t],
     [1.0f64 as vec_t, 0.0f64 as vec_t, 1.0f64 as vec_t, 1.0f64 as vec_t],
     [1.0f64 as vec_t, 1.0f64 as vec_t, 1.0f64 as vec_t, 1.0f64 as vec_t]];
#[no_mangle]
...
pub unsafe extern "C" fn ClampChar(mut i: libc::c_int) -> libc::c_schar {
    if i < -128i32 { return -128i32 as libc::c_schar }
    if i > 127i32 { return 127i32 as libc::c_schar }
    return i as libc::c_schar;
}
#[no_mangle]
pub unsafe extern "C" fn ClampShort(mut i: libc::c_int) -> libc::c_short {
    if i < -32768i32 { return -32768i32 as libc::c_short }
    if i > 0x7fffi32 { return 0x7fffi32 as libc::c_short }
...
pub unsafe extern "C" fn DirToByte(mut dir: *mut vec_t) -> libc::c_int {
    ...
    if dir.is_null() { return 0i32 }
    bestd = 0i32 as libc::c_float;
    best = 0i32;
    i = 0i32;
    while i < 162i32 {
        d =
            *dir.offset(0isize) * bytedirs[i as usize][0usize] +
...
#[no_mangle]
pub unsafe extern "C" fn _DotProduct(mut v1: *const vec_t,
                                     mut v2: *const vec_t) -> vec_t {
    return *v1.offset(0isize) * *v2.offset(0isize) +
               *v1.offset(1isize) * *v2.offset(1isize) +
               *v1.offset(2isize) * *v2.offset(2isize);
}
#[no_mangle]
pub unsafe extern "C" fn _VectorSubtract(mut veca: *const vec_t,
...
#[no_mangle]
pub unsafe extern "C" fn _VectorAdd(mut veca: *const vec_t,
                                    mut vecb: *const vec_t,
                                    mut out: *mut vec_t) {
    *out.offset(0isize) = *veca.offset(0isize) + *vecb.offset(0isize);
    *out.offset(1isize) = *veca.offset(1isize) + *vecb.offset(1isize);
...
#[no_mangle]
pub unsafe extern "C" fn _VectorCopy(mut in_0: *const vec_t,
                                     mut out: *mut vec_t) {
...
#[no_mangle]
pub unsafe extern "C" fn _VectorScale(mut in_0: *const vec_t,
                                      mut scale: vec_t, mut out: *mut vec_t) {
...
#[no_mangle]
pub unsafe extern "C" fn _VectorMA(mut veca: *const vec_t,
                                   mut scale: libc::c_float,
                                   mut vecb: *const vec_t,
                                   mut vecc: *mut vec_t) {
    *vecc.offset(0isize) =
        *veca.offset(0isize) + scale * *vecb.offset(0isize);
    *vecc.offset(1isize) =
        *veca.offset(1isize) + scale * *vecb.offset(1isize);
    *vecc.offset(2isize) =
        *veca.offset(2isize) + scale * *vecb.offset(2isize);
}
#[no_mangle]
pub unsafe extern "C" fn ColorBytes3(mut r: libc::c_float,
                                     mut g: libc::c_float,
                                     mut b: libc::c_float) -> libc::c_uint {
...
#[no_mangle]
pub unsafe extern "C" fn ColorBytes4(mut r: libc::c_float,
                                     mut g: libc::c_float,
                                     mut b: libc::c_float,
                                     mut a: libc::c_float) -> libc::c_uint {
    let mut i: libc::c_uint = 0;
    *(&mut i as *mut libc::c_uint as *mut byte).offset(0isize) =
        (r * 255i32 as libc::c_float) as byte;
    *(&mut i as *mut libc::c_uint as *mut byte).offset(1isize) =
...
#[no_mangle]
pub unsafe extern "C" fn NormalizeColor(mut in_0: *const vec_t,
                                        mut out: *mut vec_t)
 -> libc::c_float {
    let mut max: libc::c_float = 0.;
    max = *in_0.offset(0isize);
    if *in_0.offset(1isize) > max { max = *in_0.offset(1isize) }
    if *in_0.offset(2isize) > max { max = *in_0.offset(2isize) }
    if 0. == max {
    ...
    if 0. != length {
        ilength =
            1i32 as libc::c_float /
                sqrt(length as libc::c_double) as libc::c_float;
        length *= ilength;
...
#[no_mangle]
pub unsafe extern "C" fn VectorNormalize2(mut v: *const vec_t,
                                          mut out: *mut vec_t) -> vec_t {
    let mut length: libc::c_float = 0.;
    let mut ilength: libc::c_float = 0.;
    length =
        *v.offset(0isize) * *v.offset(0isize) +
...
#[no_mangle]
pub unsafe extern "C" fn Vector4Scale(mut in_0: *const vec_t,
                                      mut scale: vec_t, mut out: *mut vec_t) {
    *out.offset(0isize) = *in_0.offset(0isize) * scale;
    *out.offset(1isize) = *in_0.offset(1isize) * scale;
    *out.offset(2isize) = *in_0.offset(2isize) * scale;
...
pub unsafe extern "C" fn Q_log2(mut val: libc::c_int) -> libc::c_int {
    ...
    answer = 0i32;
    loop  { val >>= 1i32; if !(val != 0i32) { break ; } answer += 1 }
    return answer;
}
#[no_mangle]
...
pub unsafe extern "C" fn Q_rand(mut seed: *mut libc::c_int) -> libc::c_int {
    *seed =
        69069u32.wrapping_mul(*seed as libc::c_uint).wrapping_add(1u32) as
            libc::c_int;
    return *seed;
}
#[no_mangle]
pub unsafe extern "C" fn Q_random(mut seed: *mut libc::c_int)
 -> libc::c_float {
    return (Q_rand(seed) & 0xffffi32) as libc::c_float /
               0x10000i32 as libc::c_float;
}
#[no_mangle]
pub unsafe extern "C" fn Q_crandom(mut seed: *mut libc::c_int)
 -> libc::c_float {
    return (2.0f64 * (Q_random(seed) as libc::c_double - 0.5f64)) as
               libc::c_float;
}
#[no_mangle]
pub unsafe extern "C" fn vectoangles(mut value1: *const vec_t,
    ...
    if *value1.offset(1isize) == 0i32 as libc::c_float &&
        ...
        } else { pitch = 270i32 as libc::c_float }
    } else {
        if 0. != *value1.offset(0isize) {
            yaw =
                (atan2(*value1.offset(1isize) as libc::c_double,
                       *value1.offset(0isize) as libc::c_double) *
                     180i32 as libc::c_double / 3.14159265358979323846f64) as
                    libc::c_float
        } else if *value1.offset(1isize) > 0i32 as libc::c_float {
            yaw = 90i32 as libc::c_float
        } else { yaw = 270i32 as libc::c_float }
        if yaw < 0i32 as libc::c_float { yaw += 360i32 as libc::c_float }
        forward =
            sqrt((*value1.offset(0isize) * *value1.offset(0isize) +
                      *value1.offset(1isize) * *value1.offset(1isize)) as
                     libc::c_double) as libc::c_float;
        pitch =
            (atan2(*value1.offset(2isize) as libc::c_double,
                   forward as libc::c_double) * 180i32 as libc::c_double /
                 3.14159265358979323846f64) as libc::c_float;
        if pitch < 0i32 as libc::c_float { pitch += 360i32 as libc::c_float }
    }
...
#[no_mangle]
pub unsafe extern "C" fn AnglesToAxis(mut angles: *const vec_t,
                                      mut axis: *mut vec3_t) {
    let mut right: vec3_t = [0.; 3];
    AngleVectors(angles, (*axis.offset(0isize)).as_mut_ptr(),
                 right.as_mut_ptr(), (*axis.offset(2isize)).as_mut_ptr());
...
pub unsafe extern "C" fn AngleVectors(mut angles: *const vec_t,
    ...
    angle =
        (*angles.offset(1isize) as libc::c_double *
             (3.14159265358979323846f64 * 2i32 as libc::c_double /
                  360i32 as libc::c_double)) as libc::c_float;
    sy = sin(angle as libc::c_double) as libc::c_float;
    cy = cos(angle as libc::c_double) as libc::c_float;
    angle =
        (*angles.offset(0isize) as libc::c_double *
             (3.14159265358979323846f64 * 2i32 as libc::c_double /
                  360i32 as libc::c_double)) as libc::c_float;
    sp = sin(angle as libc::c_double) as libc::c_float;
    cp = cos(angle as libc::c_double) as libc::c_float;
    angle =
        (*angles.offset(2isize) as libc::c_double *
             (3.14159265358979323846f64 * 2i32 as libc::c_double /
                  360i32 as libc::c_double)) as libc::c_float;
    ...
    if !right.is_null() {
        *right.offset(0isize) =
            -1i32 as libc::c_float * sr * sp * cy +
                -1i32 as libc::c_float * cr * -sy;
        *right.offset(1isize) =
            -1i32 as libc::c_float * sr * sp * sy +
                -1i32 as libc::c_float * cr * cy;
...
#[no_mangle]
pub unsafe extern "C" fn AxisCopy(mut in_0: *mut vec3_t,
                                  mut out: *mut vec3_t) {
...
#[no_mangle]
pub unsafe extern "C" fn BoxOnPlaneSide(mut emins: *mut vec_t,
                                        mut emaxs: *mut vec_t,
                                        mut p: *mut cplane_s) -> libc::c_int {
    let mut dist: [libc::c_float; 2] = [0.; 2];
    let mut sides: libc::c_int = 0;
    let mut b: libc::c_int = 0;
    let mut i: libc::c_int = 0;
    if ((*p).type_0 as libc::c_int) < 3i32 {
        if (*p).dist <= *emins.offset((*p).type_0 as isize) { return 1i32 }
        if (*p).dist >= *emaxs.offset((*p).type_0 as isize) { return 2i32 }
        return 3i32
    }
    ...
    if ((*p).signbits as libc::c_int) < 8i32 {
        ...
        while i < 3i32 {
            ...
            dist[b as usize] +=
                (*p).normal[i as usize] * *emaxs.offset(i as isize);
    ...
    sides = 0i32;
    if dist[0usize] >= (*p).dist { sides = 1i32 }
    if dist[1usize] < (*p).dist { sides |= 2i32 }
    return sides;
}
#[no_mangle]
pub unsafe extern "C" fn BoundsIntersect(mut mins: *const vec_t,
                                         mut maxs: *const vec_t,
...
#[no_mangle]
pub unsafe extern "C" fn BoundsIntersectSphere(mut mins: *const vec_t,
                                               mut maxs: *const vec_t,
...
#[no_mangle]
pub unsafe extern "C" fn BoundsIntersectPoint(mut mins: *const vec_t,
                                              mut maxs: *const vec_t,
                                              mut origin: *const vec_t)
 -> qboolean {
...
pub unsafe extern "C" fn AngleMod(mut a: libc::c_float) -> libc::c_float {
    a =
        (360.0f64 / 65536i32 as libc::c_double *
             ((a as libc::c_double * (65536i32 as libc::c_double / 360.0f64))
                  as libc::c_int & 65535i32) as libc::c_double) as
            libc::c_float;
    return a;
}
#[no_mangle]
pub unsafe extern "C" fn LerpAngle(mut from: libc::c_float,
                                   mut to: libc::c_float,
                                   mut frac: libc::c_float) -> libc::c_float {
    let mut a: libc::c_float = 0.;
    if to - from > 180i32 as libc::c_float { to -= 360i32 as libc::c_float }
    if to - from < -180i32 as libc::c_float { to += 360i32 as libc::c_float }
    a = from + frac * (to - from);
    return a;
}
#[no_mangle]
pub unsafe extern "C" fn AngleSubtract(mut a1: libc::c_float,
                                       mut a2: libc::c_float)
 -> libc::c_float {
    let mut a: libc::c_float = 0.;
    a = a1 - a2;
    while a > 180i32 as libc::c_float { a -= 360i32 as libc::c_float }
    while a < -180i32 as libc::c_float { a += 360i32 as libc::c_float }
    return a;
}
#[no_mangle]
pub unsafe extern "C" fn AnglesSubtract(mut v1: *mut vec_t,
                                        mut v2: *mut vec_t,
                                        mut v3: *mut vec_t) {
    *v3.offset(0isize) =
        AngleSubtract(*v1.offset(0isize), *v2.offset(0isize));
    *v3.offset(1isize) =
        AngleSubtract(*v1.offset(1isize), *v2.offset(1isize));
    *v3.offset(2isize) =
        AngleSubtract(*v1.offset(2isize), *v2.offset(2isize));
}
#[no_mangle]
pub unsafe extern "C" fn AngleNormalize360(mut angle: libc::c_float)
 -> libc::c_float {
    return (360.0f64 / 65536i32 as libc::c_double *
                ((angle as libc::c_double *
                      (65536i32 as libc::c_double / 360.0f64)) as libc::c_int
                     & 65535i32) as libc::c_double) as libc::c_float;
}
#[no_mangle]
pub unsafe extern "C" fn AngleNormalize180(mut angle: libc::c_float)
 -> libc::c_float {
...
#[no_mangle]
pub unsafe extern "C" fn AngleDelta(mut angle1: libc::c_float,
                                    mut angle2: libc::c_float)
 -> libc::c_float {
    return AngleNormalize180(angle1 - angle2);
}
#[no_mangle]
pub unsafe extern "C" fn PlaneFromPoints(mut plane: *mut vec_t,
                                         mut a: *const vec_t,
                                         mut b: *const vec_t,
                                         mut c: *const vec_t) -> qboolean {
...
#[no_mangle]
pub unsafe extern "C" fn ProjectPointOnPlane(mut dst: *mut vec_t,
                                             mut p: *const vec_t,
    ...
    inv_denom =
        *normal.offset(0isize) * *normal.offset(0isize) +
            *normal.offset(1isize) * *normal.offset(1isize) +
            *normal.offset(2isize) * *normal.offset(2isize);
    if Q_fabs(inv_denom) != 0.0f32 {
    } else {
        __assert_fail(b"Q_fabs(inv_denom) != 0.0f\x00" as *const u8 as
                          *const libc::c_char,
                      b"code/qcommon/q_math.c\x00" as *const u8 as
                          *const libc::c_char, 450i32 as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 64],
                                                &[libc::c_char; 64]>(b"void ProjectPointOnPlane(vec_t *, const vec_t *, const vec_t *)\x00")).as_ptr());
    }
    inv_denom = 1.0f32 / inv_denom;
    d =
        (*normal.offset(0isize) * *p.offset(0isize) +
             *normal.offset(1isize) * *p.offset(1isize) +
             *normal.offset(2isize) * *p.offset(2isize)) * inv_denom;
...
#[no_mangle]
pub unsafe extern "C" fn RotatePointAroundVector(mut dst: *mut vec_t,
                                                 mut dir: *const vec_t,
    ...
    CrossProduct(vr.as_mut_ptr() as *const vec_t,
                 vf.as_mut_ptr() as *const vec_t, vup.as_mut_ptr());
    ...
    memcpy(im.as_mut_ptr() as *mut libc::c_void,
    ...
    memset(zrot.as_mut_ptr() as *mut libc::c_void, 0i32,
           ::std::mem::size_of::<[[libc::c_float; 3]; 3]>() as libc::c_ulong);
    ...
    while i < 3i32 {
        *dst.offset(i as isize) =
            rot[i as usize][0usize] * *point.offset(0isize) +
...
pub unsafe extern "C" fn PerpendicularVector(mut dst: *mut vec_t,
    ...
    i = 0i32;
    while i < 3i32 {
        if fabs(*src.offset(i as isize) as libc::c_double) <
               minelem as libc::c_double {
            pos = i;
            minelem =
                fabs(*src.offset(i as isize) as libc::c_double) as
                    libc::c_float
        }
        i += 1
    }
...
#[no_mangle]
pub unsafe extern "C" fn RotateAroundDirection(mut axis: *mut vec3_t,
                                               mut yaw: libc::c_float) {
    PerpendicularVector((*axis.offset(1isize)).as_mut_ptr(),
    ...
    if 0. != yaw {
        ...
        RotatePointAroundVector((*axis.offset(1isize)).as_mut_ptr(),
                                (*axis.offset(0isize)).as_mut_ptr() as
                                    *const vec_t,
                                temp.as_mut_ptr() as *const vec_t, yaw);
    }
    CrossProduct((*axis.offset(0isize)).as_mut_ptr() as *const vec_t,
                 (*axis.offset(1isize)).as_mut_ptr() as *const vec_t,
                 (*axis.offset(2isize)).as_mut_ptr());
}
#[no_mangle]
pub unsafe extern "C" fn MakeNormalVectors(mut forward: *const vec_t,
                                           mut right: *mut vec_t,
                                           mut up: *mut vec_t) {
    let mut d: libc::c_float = 0.;
    ...
    *right.offset(0isize) = *forward.offset(2isize);
    d =
        *right.offset(0isize) * *forward.offset(0isize) +
            *right.offset(1isize) * *forward.offset(1isize) +
            *right.offset(2isize) * *forward.offset(2isize);
    *right.offset(0isize) =
        *right.offset(0isize) + *forward.offset(0isize) * -d;
    *right.offset(1isize) =
        *right.offset(1isize) + *forward.offset(1isize) * -d;
    *right.offset(2isize) =
        *right.offset(2isize) + *forward.offset(2isize) * -d;
